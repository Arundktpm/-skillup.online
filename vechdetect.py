...
car_cascade = cv2.CascadeClassifier('path on haarcascade_car.xml')

# Create a VideoCapture object to capture video from a file or camera (you can specify the source)
video_source = 'path on /pexels_videos_2406459 (2160p).mp4'  # Replace with your video path or use 0 for the default camera
